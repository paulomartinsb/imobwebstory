    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
        ...
        <div className="bg-white max-w-lg w-full rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-8">
                ...
                <p className="text-slate-500 mb-6 text-sm">Preencha seus dados para receber uma consultoria personalizada.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                       <div className="flex justify-between">
                           ...
                           <div className="flex items-center gap-2">
                               ...
                               />
                               <button type="button" onClick={handleCepSearch} disabled={isCepLoading} className="text-slate-500 hover:text-primary-600">
                       ...
                       <div className="flex gap-2">
                           <input 
                                ...
                                className="flex-1 px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500/20 text-sm"
                                value={locationInput}
                       ...
                       <div className="flex flex-wrap gap-2 mt-1">
                           {formData.desiredLocation.map((loc, idx) => (
                               <span key={idx} className="flex items-center gap-1.5 px-2.5 py-1 rounded bg-indigo-50 text-indigo-700 text-sm border border-indigo-100">
                                   {loc}
                    ...
                    <div className="space-y-2 pt-2 border-t border-slate-100">
                        <label className="text-sm font-medium text-slate-700">Comodidades / Diferenciais</label>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <div className="space-y-1">
                         ...
                         <textarea 
                            className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500/20 text-sm h-24"
