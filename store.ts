...
interface AppState {
  ...
  addProperty: (property: Omit<Property, 'id' | 'authorId' | 'status'>) => void;
...
const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Carlos Admin', email: 'admin@imob.com', role: 'admin', avatar: 'https://i.pravatar.cc/150?u=u1' },
  { id: 'u2', name: 'Ana Financeiro', email: 'financeiro@imob.com', role: 'finance', avatar: 'https://i.pravatar.cc/150?u=u2' },
  { id: 'u3', name: 'Beatriz Staff', email: 'staff@imob.com', role: 'employee', avatar: 'https://i.pravatar.cc/150?u=u3' },
  { id: 'u4', name: 'João Corretor', email: 'joao@imob.com', role: 'broker', avatar: 'https://i.pravatar.cc/150?u=u4' },
  { id: 'u5', name: 'Paulo Martins', email: 'paulo@imob.com', role: 'broker', avatar: 'https://i.pravatar.cc/150?u=u5' },
];
...
const DEFAULT_PROMPT = `Atue como um assistente imobiliário técnico e objetivo.
...
export const useStore = create<AppState>((set, get) => ({
  ...
  systemSettings: {
      ...
      propertyDescriptionPrompt: DEFAULT_PROMPT
  },
  ...
  restoreState: (logId) => { /* Same as before */ }
}));